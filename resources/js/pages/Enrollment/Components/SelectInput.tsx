    ...
    return (
        <div className="mb-4">
            ...
            <select
                ...
                className={`w-full rounded-lg border bg-white px-3 py-2 text-sm text-[#1F2A24] shadow-sm transition-colors focus:border-[#2F6F4E] focus:ring-2 focus:ring-[#2F6F4E]/30 focus:outline-none ${
